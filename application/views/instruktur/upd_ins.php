        ...
        <div class="widget-content nopadding">
          <form action="<?php echo base_url(). 'Dashboard/updatingIns'; ?>" method="POST" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <input type="text" class="span11" placeholder="Masukan Nama Lengkap" name="nama" value="<?php echo $i->nama; ?>" readonly/>
              </div>
            </div>
           <div class="control-group">
              <label class="control-label">Tempat Lahir :</label>
              <div class="controls">
                <input type="text" class="span11" placeholder="Contoh : Bandung" name="tempat_lahir" value="" readonly />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Tanggal Lahir :</label>
              <div class="controls">
                <input type="text" data-date="01-02-2013" data-date-format="dd-mm-yyyy" class="datepicker span11" name="tgl_lahir" readonly>
                </div>
            </div>
             <div class="control-group">
              <label class="control-label">Alamat Lengkap :</label>
              <div class="controls">
               <textarea class="span11" name="alamat" placeholder="" readonly><?php echo $i->alamat; ?></textarea>
            </div>
            </div>
             <div class="control-group">
              <label for="normal" class="control-label">No. Kontak :</label>
              <div class="controls">
                <input type="text" id="mask" class="span8 mask text" name="no_kontak" value="<?php echo $i->no_kontak; ?>" readonly>
              </div>
            </div>
            <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Informasi Keahlian</h5>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" placeholder="Masukan Asal Instansi" name="asal_instansi" value="<?php echo $i->asal_instansi; ?>" readonly/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Spesialisasi :</label>
              <div class="controls">
                <input type="text" class="span11" name="spesialisasi" value="<?php echo $i->spesialisasi; ?> "readonly>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Keterangan :</label>
              <div class="controls">
               <textarea class="span11" name="ket" placeholder="" readonly><?php echo $i->deskripsi; ?></textarea>
                <span class="help-block">Deskripsi tambahan</span> </div>
            </div>

        </div>
        <div class="form-actions">
              <button type="submit"  data-toggle="modal" data-target="#modal-edit" class="btn btn-success pull-right">Edit</button>
          </form>
  ...
  <div class="modal fade" id="modal-edit" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header">
              <h4 class="modal-title" style="text-align: center;" id="exampleModalLabel">Update Employee</h4>
          </div>
       <!-- BODY -->
    ...
    <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
     <h5>Informasi Umum</h5>
        ...
        <div class="widget-content nopadding">
             <?php foreach($instruktur as $i){ ?>
            <form action="<?php echo base_url(). 'index.php/Dashboard/updatingIns/'.$i->id; ?>" method="POST" class="form-horizontal">
                <div class="control-group">
                   <input type="hidden" name="id" value= "<?php echo $i->id ?>">
                  <label class="control-label">Nama Lengkap :</label>
                  <div class="controls">
