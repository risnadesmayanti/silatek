...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?php echo base_url(); ?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Beranda</a></div>
  </div>
<!--End-breadcrumbs-->
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="#"> <i class="icon-group"></i> <span class="label label-important">20</span> Jumlah Instruktur </a> </li>
        <li class="bg_lg"> <a href="charts.html"> <i class="icon-calendar"></i> Jadwal Tersedia</a> </li>
        <li class="bg_lo"> <a href="widgets.html"> <i class="icon-ok"></i> Total Pelatihan Approve </a> </li>
